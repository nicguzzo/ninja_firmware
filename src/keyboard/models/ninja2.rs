...
impl KeyboardTrait for Ninja {
    ...
    fn get_default_keys()->Keys{
        [
            [
                [
                    [Key::Code(K::Escape),Key::Code(K::Keyboard1),Key::Code(K::Keyboard2),Key::Code(K::Keyboard3),Key::Code(K::Keyboard4),Key::Code(K::Keyboard5)],
                    [Key::Code(K::Tab),Key::Code(K::Q),Key::Code(K::W),Key::Code(K::E),Key::Code(K::R),Key::Code(K::T)],
                    [Key::Code(K::LeftShift),Key::Code(K::A),Key::Code(K::S),Key::Code(K::D),Key::Code(K::F),Key::Code(K::G)],
                    [Key::Code(K::LeftControl),Key::Code(K::Z),Key::Code(K::X),Key::Code(K::C),Key::Code(K::V),Key::Code(K::B)],
                    [Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey,Key::Code(K::LeftGUI),Key::Layer(LayerCMD::TMP(1)) ],
            ...
            [
                [
                    [Key::Code(K::Keyboard6),Key::Code(K::Keyboard7),Key::Code(K::Keyboard8),Key::Code(K::Keyboard9),Key::Code(K::Keyboard0),Key::Code(K::Equal)],
                    ...
                    [Key::Code(K::ReturnEnter),Key::Code(K::Space),Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey],
                ],
                [
                    [Key::Code(K::F7),Key::Code(K::F8),Key::Code(K::F9),Key::Code(K::F10),Key::Code(K::F11),Key::Code(K::F12) ],
                    [Key::Code(K::Home),Key::Code(K::UpArrow),Key::Code(K::End),Key::NoKey,Key::NoKey,Key::NoKey],
                    [Key::Code(K::LeftArrow)  ,Key::Code(K::DownArrow),Key::Code(K::RightArrow) ,Key::Code(K::PageUp),Key::Code(K::PageDown),Key::Code(K::Minus) ],
                    [Key::Code(K::DeleteForward),Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey],
                    [Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey],
                ],
                [
                    [Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey,Key::NoKey],
